...
<sess:equalsAttribute name="jsp_payment_method" match="bank">    
    <tr class="infoB">
        <td class="infoprompt"><bean:message key="payment.bank.paidto"/></td>
    <td class="infodata">	
    <bean:write name="dto" property="bank.paidTo" scope="page"/>
    </td>
    </tr>
    <tr class="infoA">
        <td class="infoprompt"><bean:message key="payment.bank.ref"/></td>
    <td class="infodata">	
    <bean:write name="dto" property="bank.bankRef" scope="page"/>
    </td>
    </tr>		
    <tr class="infoB">
        <td class="infoprompt"><bean:message key="payment.bank.date"/></td>
    <td class="infodata">	
    <bean:write name="dto" property="bank.date" scope="page" formatKey="format.date"/>
    </td>
    </tr>
</sess:equalsAttribute>
